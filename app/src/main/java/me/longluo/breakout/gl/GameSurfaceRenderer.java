...
import me.longluo.breakout.control.GameState;
...
import me.longluo.breakout.util.Utils;
...
public class GameSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        Timber.i("onSurfaceChanged w = " + width + " h = " + height);
        Timber.i(" --> x = " + x + " y = " + y + " gw = " + viewWidth + " gh = " + viewHeight);
...
//        catch (InterruptedException ie) {}
        ...
        if (!gameState.isAnimating()) {
            Timber.d("Game over, stopping animation");
